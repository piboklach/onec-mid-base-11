...
// Добавляет элементы и команды на форму.
// Для вызова из Общего модуля ПодключаемыеКоманды.
//
// Параметры:
...
// Начало.БоклачПИ 22.12.2025 homework-13-7
// Добавляет Поле КонтактноеЛицо на форму В ГруппаШапкаПраво.
// Для вызова из Процедуры ДополнитьФорму.
//
// Параметры:
//   Форма - ФормаКлиентскогоПриложения - форма, в которой необходимо разместить команды.
//
...
// Начало.БоклачПИ 22.12.2025 homework-13-7
// Добавляет Поле КонтактноеЛицо на форму Перед СуммаДокумента.
// Для вызова из Процедуры ДополнитьФорму.
//
// Параметры:
//   Форма - ФормаКлиентскогоПриложения - форма, в которой необходимо разместить команды.
...
// Начало.БоклачПИ 22.12.2025 homework-13-7
// Добавляет Поля СогласованнаяСкидка и ПересчитатьТаблицу на форму В Группу ШапкаЛево.
// Для вызова из Процедуры ДополнитьФорму.
//
// Параметры:
//   Форма - ФормаКлиентскогоПриложения - форма, в которой необходимо разместить команды.
...
Процедура ДобавитьПоляСогласованнаяСкидкаИПересчитатьТаблицуВГруппаШапкаЛево(Форма) Экспорт
	...
	ПолеВвода.УстановитьДействие("ПриИзменении", "Подключаемый_Дораб_СогласованнаяСкидкаПриИзменении");
...
// Начало.БоклачПИ 22.12.2025 homework-13-7
// Добавляет Поле СтатусЗаказа на форму В Группу ШапкаЛево.
// Для вызова из Процедуры ДополнитьФорму.
//
// Параметры:
//   Форма - ФормаКлиентскогоПриложения - форма, в которой необходимо разместить команды.
...
// Начало.БоклачПИ 22.12.2025 homework-13-7
// Добавляет Колонку СтатусЗаказа на форму Списка.
// Для вызова из Процедуры ДополнитьФорму.
//
// Параметры:
//   Форма - ФормаКлиентскогоПриложения - форма, в которой необходимо разместить команды.
